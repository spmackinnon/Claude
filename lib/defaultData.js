...
export const defaultData = {
  ...
  taskLists: {
    ...
    'routines': [
      { id: 'r1', text: 'Sunday grocery run', completed: false, dueDate: '', notes: '', links: [], priority: null, assignedTo: null },
      { id: 'r2', text: 'Weekly house tidy', completed: false, dueDate: '', notes: '', links: [], priority: null, assignedTo: null },
      { id: 'r3', text: 'Pay any outstanding bills', completed: false, dueDate: '', notes: '', links: [], priority: null, assignedTo: null },
    ],
    'errands': [
