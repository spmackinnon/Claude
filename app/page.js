  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <Navigation
        ...
        onProjectLibraryOpen={() => setCurrentSpace('project-library')}
      />
        ...
        <div className="px-4 py-6 md:px-8 md:py-8 max-w-3xl">
          ...
          <div className="md:hidden flex items-center justify-between mb-5">
            ...
            <div className="flex gap-2">
              <button onClick={() => setCurrentSpace('project-library')} className={`p-1.5 rounded-lg transition-all ${currentSpace === 'project-library' ? 'text-sage-600 bg-sage-50' : 'text-stone-400 hover:text-stone-600 hover:bg-stone-100'}`} title="Project Library">
          ...
          {currentSpace === 'project-library' && <ProjectLibrary projects={data.projects} onUpdate={updateData} onNavigate={setCurrentSpace} />}
